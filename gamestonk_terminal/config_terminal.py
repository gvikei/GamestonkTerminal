...
API_REDDIT_CLIENT_SECRET = os.getenv("GT_API_REDDIT_CLIENT_SECRET") or "REPLACE_ME-n62b72MCnzsQ"
...
DISCORD_TOKEN = os.getenv("GT_DISCORD_TOKEN") or "REPLACE_ME"
DISCORD_GUILD = os.getenv("GT_DISCORD_GUILD") or "REPLACE_ME"